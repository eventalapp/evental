	...
	return (
		<PageWrapper variant="white">
			...
			<Column className="flex flex-col items-center">
				...
				<div className="bg-white border-gray-300 border rounded shadow-sm p-5 flex flex-col justify-between items-center space-y-4 max-w-[450px] min-h-[350px] mt-3">
			...
			<div className="bg-primary text-white my-10 md:my-0 py-4">
				<Column className="flex items-center justify-center">
					<div className="flex flex-row flex-wrap items-center justify-center space-x-4">
						<p className="text-sm md:text-lg text-center my-1.5">
			...
			<div className="bg-gray-100 my-10 md:my-0 py-4">
							...
							},
							{
								...
								content: (
									<p>
										...
										administrators go through our support guides & video tutorials, view at least
										one webinar recording, and set up your event.
									</p>
								)
							},
							{
							...
							},
							{
								...
								content: (
									<p>
										...
										purchasing. You can start creating your event here. You can also contact us if
										you require a longer free trial period. Note: You won’t have full functionality
										and/or a live event whilst you’re in the free trial mode but if you did want to
										test it in this capacity, contact us and we can set your event live for a few
										days.
									</p>
								)
							}
			...
			<Column>
				<h3 className="text-2xl font-bold">See why Evental is perfect for your event!</h3>
			</Column>
		</PageWrapper>
	);
};
