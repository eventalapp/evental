			...
			<div className="relative flex w-full border-b border-gray-200 mb-3">
				<NavigationMenuPrimitive.Root className="relative">
					<NavigationMenuPrimitive.List className="flex flex-row rounded-lg bg-white dark:bg-gray-800 px-2 pt-2 space-x-2 flex-wrap">
						<LinkItem link={`/events/${eid}/admin/attendees`} label={'Attendees'} />
						<LinkItem link={`/events/${eid}/admin/roles`} label={'Roles'} />
						<LinkItem link={`/events/${eid}/admin/venues`} label={'Venues'} />
						<LinkItem link={`/events/${eid}/admin/sessions`} label={'Sessions'} />
						<LinkItem link={`/events/${eid}/admin`} label={'Settings'} />
