		...
		<Fragment>
			...
			>
				<div className="absolute inset-0 z-10 flex items-center justify-center">
					<h3 className="select-none bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-2xl font-black uppercase text-transparent duration-300 ease-in-out group-hover:opacity-0 sm:text-4xl md:text-3xl">
						Vancouver
					</h3>
				</div>
				<div
