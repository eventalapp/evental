	...
	return (
		<div>
			<ContextMenuPrimitive.Root>
				<ContextMenuPrimitive.Trigger className="inline-flex w-36 items-center justify-center rounded-md border border-dashed border-gray-500 bg-white py-4 px-3 dark:border-gray-300 dark:bg-gray-800">
				...
				>
					...
					<ContextMenuPrimitive.Label className="select-none p-2 text-xs text-gray-700 dark:text-gray-200">
						Region Tools
