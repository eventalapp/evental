...
const Toolbar = (props: Props) => {
	return (
		<ToolbarPrimitive.Root className="flex space-x-4 rounded-lg bg-white py-2 px-2.5 dark:bg-gray-800">
				...
				{fontSettings.map(({ value, label, icon }, i) => (
					<ToolbarPrimitive.ToggleItem
						...
						className={cx(
							...
							'focus:relative focus:outline-none focus-visible:z-20 focus-visible:ring focus-visible:ring-primary-500 focus-visible:ring-opacity-75'
						)}
					>
			...
			<ToolbarPrimitive.Separator className="my-0.5 mx-4 hidden h-auto w-px dark:bg-gray-600 xl:flex" />

			<span className="hidden items-center pr-2 xl:flex">
				<ToolbarPrimitive.Link
					className={cx(
						'text-sm text-gray-500 dark:text-gray-400',
						'focus:outline-none focus-visible:z-20 focus-visible:ring focus-visible:ring-primary-500 focus-visible:ring-opacity-75'
					)}
